...
function Navbar2() {
  ...
  return (
    <div className="font-bold text-white bg-blue-600 text-2xl md:text-2xl">
      {/* Logo (Centered on Desktop) */}
      <div className={`fixed top-0 left-0 w-full ${scrolling ? 'bg-[#000d6b] text-white shadow-2xl' : 'bg-transparent'} transition-all duration-300 z-50`}>
