...
const vehicles = [
  ...
  {
    img: '/assets/parts-img/part10.jpeg',
    name: 'SparkPlugs',
  ...
  {
    img: '/assets/parts-img/part11.jpeg',
    name: 'Borrel',
  ...
  {
    img: '/assets/parts-img/part12.jpeg',
    name: 'OilFilter ',
    description: '4.0 D5 PowerPulse Momentum 5dr AW… Geartronic Estate',
    details: [
  ...
  {
    img: '/assets/parts-img/part17.jpeg',
    name: 'Shock Absorber',
    description: '4.0 D5 PowerPulse Momentum 5dr AW… Geartronic Estate',
    details: [
...
const Part2 = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const element = document.getElementById('part2-carousel');
      if (element) {
  ...
  return (
    <div id="part2-carousel" className="relative w-full sm:px-10">
      <motion.div
