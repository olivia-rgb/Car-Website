...
import backgroundImage from "../../../public/assets/bg-img/bgcar2.jpeg"; // Adjust the path as needed
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex justify-center items-center flex-col md:flex-row mx-auto w-10/12 gap-10 pt-4"
      >
