    ...
    <div className="font-bold text-[#000d6b] text-2xl md:text-xl">
      ...
      <div className="fixed top-0 left-0 w-full bg-white shadow-md z-50">
        <div className="hidden md:flex justify-between items-center w-10/12 mx-auto py-2">
          ...
          <img src="/assets/brand-img/brand3.jpg.png" alt="logo" className="w-20 mx-auto" />
          <div className="flex gap-8">
            <button className="bg-[#f9a826] rounded-md border border-blue-500 text-[#000d6b] px-4 py-1">Buy Car</button>
            <button className="bg-[#f9a826] rounded-md border border-blue-500 text-[#000d6b] px-4 py-1">Sell Car</button>
          </div>
        </div>
      </div>

      {/* Hamburger Menu (Mobile View) */}
      <div className="md:hidden fixed top-0 left-0 w-full bg-white shadow-md z-50 py-2">
        <div className="flex justify-between items-center px-4">
          <img src="/assets/brand-img/brand3.jpg.png" alt="logo" className="w-20" />
      ...
      {/* Mobile Menu Overlay */}
      {showMenu && (
        <div className="md:hidden fixed inset-0 top-14 bg-[#000d6b] text-white font-bold flex flex-col justify-center items-center z-40 overflow-auto">
