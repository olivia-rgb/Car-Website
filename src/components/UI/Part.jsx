...
const vehicles = [
  ...
  {
    img: '/assets/parts-img/part1.jpeg',
  ...
  {
    img: '/assets/parts-img/part6.jpeg',
    name: 'T-Cross – 2023',
  ...
  {
    img: '/assets/parts-img/part8.jpeg',
    name: 'C-Class – 2023',
    description: '4.0 D5 PowerPulse Momentum 5dr AW… Geartronic Estate',
    details: [
  ...
  {
    img: '/assets/parts-img/part9.jpeg',
...
const Part  = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const element = document.getElementById('part-carousel');
      if (element) {
  ...
  return (
    <div id="part-carousel" className="relative w-full sm:px-10">
      <motion.div
