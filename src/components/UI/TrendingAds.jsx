...
const TrendingAds = () => {
  return (
    <div className="w-full sm:w-11/12  mx-auto flex flex-col justify-center px-2 md:px-2 mb-40 mt-72 md:mt-48 gap-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="flex flex-col bg-white shadow-lg items-center">
          <img src="/assets/vehicle-img/car4.png" alt="Car" className="w-full h-32 md:h-48 object-cover mb-2" />
          <span className="font-bold text-xl  py-2 text-[#000d6b]">Car</span>
        ...
        <div className="flex flex-col bg-white shadow-lg items-center">
          ...
          <span className="font-bold  py-2 text-xl text-[#000d6b]">Part 1</span>
        ...
        <div className="flex flex-col bg-white shadow-lg items-center">
          ...
          <span className="font-bold py-2 text-xl text-[#000d6b]">Bike</span>
        ...
        <div className="flex flex-col bg-white shadow-lg items-center">
          ...
          <span className="font-bold py-2 text-xl text-[#000d6b]">Bus</span>
        ...
        <div className="flex flex-col bg-white shadow-lg items-center">
          ...
          <span className="font-bold py-2 text-xl text-[#000d6b]">Part 2</span>
        ...
        <div className="flex flex-col bg-white shadow-lg items-center">
          ...
          <span className="font-bold  py-2 text-xl  text-[#000d6b]">Bus 2</span>
        ...
        <div className="flex flex-col bg-white shadow-lg items-center">
          ...
          <span className="font-bold text-xl text-[#000d6b]">Heavy Equipment</span>
        ...
        <div className="flex flex-col bg-white shadow-lg items-center">
          ...
          <span className="font-bold text-xl text-[#000d6b]">Part 3</span>
        ...
        <div className="flex flex-col bg-white shadow-lg items-center">
          ...
          <span className="font-bold text-xl text-[#000d6b]">Heavy Equipment 2</span>
        ...
        <div className="flex flex-col bg-white shadow-lg items-center">
          ...
          <span className="font-bold text-xl  text-[#000d6b]">Car 2</span>
        ...
        <div className="flex flex-col bg-white shadow-lg items-center">
          ...
          <span className="font-bold text-xl text-[#000d6b]">Bike 2</span>
        ...
        <div className="flex flex-col bg-white shadow-lg items-center">
          ...
          <span className="font-bold text-xl text-[#000d6b]">Car 3</span>
          <span className="text-[#f9a826]">$20,000</span>
        </div>
      </div>
    </div>
