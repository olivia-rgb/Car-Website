...
const TrendingAds = () => {
  return (
    <div className="w-full sm:w-10/12 h-screen mx-auto grid grid-rows-8 my-20 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-40 mb-20 z-10 h-[250vh] sm:h-[140vh]">
