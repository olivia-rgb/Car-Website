...
const vehicles = [
  ...
  {
    img: '/assets/bike-img/bike21.jpeg',
    name: 'Tricycle-',
  ...
  {
    img: '/assets/bike-img/bike9.jpeg',
    name: 'StormBike-',
  ...
  {
    img: '/assets/bike-img/bike10.jpeg',
    name: 'JetScoot-',
    description: '4.0 D5 PowerPulse Momentum 5dr AW… Geartronic Estate',
    details: [
  ...
  {
    img: '/assets/bike-img/bike12.jpeg',
    name: 'EcoScoot-',
    description: '4.0 D5 PowerPulse Momentum 5dr AW… Geartronic Estate',
    details: [
  ...
  {
    img: '/assets/bike-img/bike13.jpeg',
    name: 'ToJetScoot-',
    description: '3.5 D5 PowerPulse Momentum 5dr AW… Geartronic Estate',
    details: [
      { icon: <LuClock className="w-4 h-4 text-[#f9a826]" />, label: '20 Miles' },
  ...
  {
    img: '/assets/bike-img/bike14.jpeg',
    name: 'JetScoot-',
    description: '4.0 D5 PowerPulse Momentum 5dr AW… Geartronic Estate',
    details: [
      { icon: <LuClock className="w-4 h-4 text-[#f9a826]" />, label: '50 Miles' },
...
const Bike2 = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const element = document.getElementById('bike2-carousel');
      if (element) {
  ...
  return (
    <div id="bike2-carousel" className="relative w-full sm:px-10">
      <motion.div
          ...
          <div className={`grid ${itemsPerPage === 2 ? 'grid-cols-2' : 'grid-cols-4'} gap-4`}>
            <AnimatePresence initial={false}>
              {currentVehicles.map((vehicle, index) => (
                ...
                >
                  <img src={vehicle.img} alt={vehicle.name} className="w-full h-30 md:h-49 object-cover" />
                  <div className="p-4">
