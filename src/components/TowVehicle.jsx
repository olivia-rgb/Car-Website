...
function TowVehicle() {
  ...
  <motion.div
    ...
    className="my-20 py-12 bg-cover md:bg-contain bg-center w-full h-[70vh] md:h-[65vh] relative"
    style={{ backgroundImage: `url(${towImage})` }}
  >
    <div className="bg-black w-full h-full opacity-40 absolute top-0 left-0" style={{ zIndex: 1 }}></div>
